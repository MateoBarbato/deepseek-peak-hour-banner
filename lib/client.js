...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function labelStyle(peak) {
			return {
				fontWeight: 600,
				letterSpacing: "0.02em",
				color: peak ? "var(--dsw-alias-state-warn-label, #b45309)" : "inherit"
			};
		}
		...
		function PeakHourDock() {
			...
			return react.createElement(
				...
				react.createElement("span", { "aria-hidden": "true" }, peak ? "⚡" : "✓"),
				react.createElement("span", { style: labelStyle(peak) }, peak ? "HORA PICO · tarifas al doble" : "Fuera de hora pico · tarifa reducida"),
				detail === "" ? null : react.createElement("span", { style: detailStyle }, detail)
			);
		}
		//#endregion
